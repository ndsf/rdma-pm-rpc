...
PROTOBUF_NAMESPACE_OPEN
template<> ::rdmarpc::RpcMeta* Arena::CreateMaybeMessage<::rdmarpc::RpcMeta>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace rdmarpc {
...
class RpcMeta PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:rdmarpc.RpcMeta) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rdmarpc.RpcMeta)
 private:
  class _Internal;
...
inline const std::string& RpcMeta::service_name() const {
  // @@protoc_insertion_point(field_get:rdmarpc.RpcMeta.service_name)
  return _internal_service_name();
}
inline void RpcMeta::set_service_name(const std::string& value) {
  _internal_set_service_name(value);
  // @@protoc_insertion_point(field_set:rdmarpc.RpcMeta.service_name)
}
inline std::string* RpcMeta::mutable_service_name() {
  // @@protoc_insertion_point(field_mutable:rdmarpc.RpcMeta.service_name)
...
inline void RpcMeta::set_service_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:rdmarpc.RpcMeta.service_name)
}
inline void RpcMeta::set_service_name(const char* value) {
  ...
  service_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:rdmarpc.RpcMeta.service_name)
}
inline void RpcMeta::set_service_name(const void* value,
  ...
  // @@protoc_insertion_point(field_set_pointer:rdmarpc.RpcMeta.service_name)
}
...
inline std::string* RpcMeta::release_service_name() {
  // @@protoc_insertion_point(field_release:rdmarpc.RpcMeta.service_name)
...
inline void RpcMeta::set_allocated_service_name(std::string* service_name) {
  ...
  service_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), service_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:rdmarpc.RpcMeta.service_name)
}
...
inline const std::string& RpcMeta::method_name() const {
  // @@protoc_insertion_point(field_get:rdmarpc.RpcMeta.method_name)
  return _internal_method_name();
}
inline void RpcMeta::set_method_name(const std::string& value) {
  _internal_set_method_name(value);
  // @@protoc_insertion_point(field_set:rdmarpc.RpcMeta.method_name)
}
inline std::string* RpcMeta::mutable_method_name() {
  // @@protoc_insertion_point(field_mutable:rdmarpc.RpcMeta.method_name)
...
inline void RpcMeta::set_method_name(std::string&& value) {
  ...
  method_name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:rdmarpc.RpcMeta.method_name)
}
inline void RpcMeta::set_method_name(const char* value) {
  ...
  method_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:rdmarpc.RpcMeta.method_name)
}
inline void RpcMeta::set_method_name(const void* value,
  ...
  method_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:rdmarpc.RpcMeta.method_name)
}
...
inline std::string* RpcMeta::release_method_name() {
  // @@protoc_insertion_point(field_release:rdmarpc.RpcMeta.method_name)
...
inline void RpcMeta::set_allocated_method_name(std::string* method_name) {
  ...
  method_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), method_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:rdmarpc.RpcMeta.method_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 RpcMeta::data_size() const {
  // @@protoc_insertion_point(field_get:rdmarpc.RpcMeta.data_size)
...
inline void RpcMeta::set_data_size(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:rdmarpc.RpcMeta.data_size)
}
