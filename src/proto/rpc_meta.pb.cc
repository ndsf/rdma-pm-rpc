...
static void InitDefaultsscc_info_RpcMeta_rpc_5fmeta_2eproto() {
  ...
  {
    void* ptr = &::rdmarpc::_RpcMeta_default_instance_;
    new (ptr) ::rdmarpc::RpcMeta();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::rdmarpc::RpcMeta::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpc_5fmeta_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::rdmarpc::RpcMeta, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::rdmarpc::RpcMeta, service_name_),
  PROTOBUF_FIELD_OFFSET(::rdmarpc::RpcMeta, method_name_),
  PROTOBUF_FIELD_OFFSET(::rdmarpc::RpcMeta, data_size_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::rdmarpc::RpcMeta)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::rdmarpc::_RpcMeta_default_instance_),
};

const char descriptor_table_protodef_rpc_5fmeta_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016rpc_meta.proto\022\007rdmarpc\"G\n\007RpcMeta\022\024\n\014"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpc_5fmeta_2eproto = {
  false, false, descriptor_table_protodef_rpc_5fmeta_2eproto, "rpc_meta.proto", 111,
...
RpcMeta::RpcMeta(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:rdmarpc.RpcMeta)
}
RpcMeta::RpcMeta(const RpcMeta& from)
  ...
  // @@protoc_insertion_point(copy_constructor:rdmarpc.RpcMeta)
}
...
RpcMeta::~RpcMeta() {
  // @@protoc_insertion_point(destructor:rdmarpc.RpcMeta)
  SharedDtor();
...
void RpcMeta::Clear() {
// @@protoc_insertion_point(message_clear_start:rdmarpc.RpcMeta)
...
::PROTOBUF_NAMESPACE_ID::uint8* RpcMeta::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:rdmarpc.RpcMeta)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:rdmarpc.RpcMeta)
  return target;
}

size_t RpcMeta::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:rdmarpc.RpcMeta)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:rdmarpc.RpcMeta)
  GOOGLE_DCHECK_NE(&from, this);
  const RpcMeta* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RpcMeta>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:rdmarpc.RpcMeta)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:rdmarpc.RpcMeta)
    MergeFrom(*source);
  }
}

void RpcMeta::MergeFrom(const RpcMeta& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:rdmarpc.RpcMeta)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:rdmarpc.RpcMeta)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:rdmarpc.RpcMeta)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::rdmarpc::RpcMeta* Arena::CreateMaybeMessage< ::rdmarpc::RpcMeta >(Arena* arena) {
  return Arena::CreateMessageInternal< ::rdmarpc::RpcMeta >(arena);
}
